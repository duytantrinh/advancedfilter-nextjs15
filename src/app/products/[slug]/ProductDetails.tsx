...
export default function ProductDetails({ product }: ProductDetailsProps) {
  ...
  //   ?.reduce((acc, curr) => ({ ...acc, ...curr }), {}) || {}, change all choices to <Record> type</Record>
  ...
  // !! take value return and turn to boolean => !!availableQuantity === true when > 0
  const availableQuantityExceeded =
    !!availableQuantity && quantity > availableQuantity;

  // (an array only contain Image/video item of CURRENT SELECTED ITEM)
  ...
  return (
    <>
      <div className="flex flex-col gap-10 md:flex-row lg:gap-20">
        ...
        <div className="basic-3/5 space-y-5">
          ...
          {inStock ? (
            ...
            // get notification when empty product
