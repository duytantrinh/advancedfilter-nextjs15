...
interface ProductOptionsProps {
  ...
  selectedOptions: Record<string, string>; // === Record return key:value , i.e: color:brown && size:11
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            {option.choices?.map((choice) => (
              <div key={choice.description}>
                <input
                  type="radio"
                  id={choice.description} // required id to choose option
                  name={option.name} // identify which option is checked
