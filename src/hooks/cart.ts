...
// initialData: data get back from fetching
...
export function useAddItemToCart() {
  ...
  return useMutation({
    ...
    onSuccess(data) {
      ...
      queryClient.cancelQueries({ queryKey }); // cancel Qeury first
      queryClient.setQueryData(queryKey, data.cart); // set newQuery
    },
    onError(error) {
      console.error(error);
      toast({
